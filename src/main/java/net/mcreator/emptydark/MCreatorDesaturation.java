package net.mcreator.emptydark;
...
@Elementsemptydark.ModElement.Tag
public class MCreatorDesaturation extends Elementsemptydark.ModElement {
	@ObjectHolder("emptydark:desaturation")
	public static final CustomBiome biome = null;

	public MCreatorDesaturation(Elementsemptydark instance) {
		super(instance, 4);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder()
					...
					.waterColor(-6710887)
					.waterFogColor(-6710887)
					.surfaceBuilder(
							SurfaceBuilder.DEFAULT,
							new SurfaceBuilderConfig(MCreatorGreyGrass.block.getDefaultState(), MCreatorGreyDirt.block.getDefaultState(),
									MCreatorGreyDirt.block.getDefaultState())));
			setRegistryName("desaturation");
	...
	static class CustomTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
		...
		public boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldgen, Random rand, BlockPos position, MutableBoundingBox bbox) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == MCreatorGreyGrass.block.getDefaultState().getBlock() || ground == MCreatorGreyDirt.block.getDefaultState()
							.getBlock()) && (ground2 == MCreatorGreyGrass.block.getDefaultState().getBlock() || ground2 == MCreatorGreyDirt.block
							.getDefaultState().getBlock())))
						return false;
					BlockState state = world.getBlockState(position.down());
					if (position.getY() < world.getHeight() - height - 1) {
						setTreeBlockState(changedBlocks, world, position.down(), MCreatorGreyDirt.block.getDefaultState(), bbox);
								...
								for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2) {
									...
									if (Math.abs(position.getX()) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0) {
										...
										if (state.getBlock().isAir(state, world, blockpos) || state.getMaterial().blocksMovement()
												...
												|| state.getBlock() == MCreatorGreyOakLeaves.block.getDefaultState().getBlock()) {
											setTreeBlockState(changedBlocks, world, blockpos, MCreatorGreyOakLeaves.block.getDefaultState(), bbox);
										}
									}
								}
							}
						...
						for (int genh = 0; genh < height; genh++) {
							...
							setTreeBlockState(changedBlocks, world, genhPos, MCreatorGreyOakWood.block.getDefaultState(), bbox);
		...
		private boolean canGrowInto(Block blockType) {
			return blockType.getDefaultState().getMaterial() == Material.AIR || blockType == MCreatorGreyOakWood.block.getDefaultState().getBlock()
					|| blockType == MCreatorGreyOakLeaves.block.getDefaultState().getBlock()
					|| blockType == MCreatorGreyGrass.block.getDefaultState().getBlock()
					|| blockType == MCreatorGreyDirt.block.getDefaultState().getBlock();
		}
